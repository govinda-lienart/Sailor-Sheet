        // =====================================================================
        // NOTE: Update Form Document Upload functionality moved to update-form-upload.js
        // NOTE: Transaction Search functionality moved to search-transaction.js
        // =====================================================================
        ...
        function selectCountry(countryCode) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    setTimeout(() => {
                        if (typeof regenerateTransactionNumberForCountry === 'function') {
        ...
        // Transaction number functions are now loaded from modules via global-bridge.js
